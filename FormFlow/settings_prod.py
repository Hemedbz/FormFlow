"""
Django settings for FormFlow project.
...
SECRET_KEY = open('../docs/key_for_settings.txt').read()

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'database-1.cmg7dtskfwxp.us-east-2.rds.amazonaws.com']
